...
public class SecretMessageBox {
	...
	public static void main(String[] args) {
		...
		String guess = JOptionPane.showInputDialog("If you want to see the secret Message, then guess the passcode! Hint: it's Mana's favorite food.");
